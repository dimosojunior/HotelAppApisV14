...
class RestaurantFoodProductsViewSet(APIView):
    def get(self, request):
        try:
            ...
            serializer = RestaurantFoodProductsSerializer(page_items, many=True)
...
class RestaurantDrinksProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            serializer = RestaurantDrinksProductsSerializer(page_items, many=True)
...
class RestaurantOthersProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            queryset = RestaurantOthersProducts.objects.filter(
                productCategory__id__icontains = categoryId
                )
            ...
            serializer = RestaurantOthersProductsSerializer(page_items, many=True)
...
class RestaurantInventoryViewSet(APIView):
    def get(self, request):
        try:
            ...
            return Response({'error': str(e), "queryset":[]}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
class RestaurantFoodCategoriesViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            serializer = RestaurantFoodCategoriesSerializer(page_items, many=True)
...
class RestaurantDrinksCategoriesViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            serializer = RestaurantDrinksCategoriesSerializer(page_items, many=True)
...
class RestaurantOthersCategoriesViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            serializer = RestaurantOthersCategoriesSerializer(page_items, many=True)
...
# EG: 
#https://Restaurantappapisv3.pythonanywhere.com/Restaurant/RestaurantPizzaProducts/?page=1&page_size=8
class RestaurantPizzaProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            queryset = RestaurantFoodProducts.objects.filter(
                productCategory__CategoryName__icontains="Pizza"
            )
...
class RestaurantOtherFoodProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            queryset = RestaurantFoodProducts.objects.filter(
                productCategory__CategoryName__icontains="Other Food"
            )
...
class RestaurantSoftDrinksProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            queryset = RestaurantDrinksProducts.objects.filter(
                productCategory__CategoryName__icontains="Soft Drinks"
            )
...
class RestaurantBeersProductsViewSet(APIView):
    def get(self, request):
        try:
            # Get the page number from the query parameters, default to 1
            page = int(request.query_params.get('page', 1))
            ...
            queryset = RestaurantDrinksProducts.objects.filter(
                productCategory__CategoryName__icontains="Beers"
            )
