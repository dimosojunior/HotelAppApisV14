...
#----------Restaurant FOOD PRODUCTS CATEGORIES-------------------
class AddRestaurantFoodCategoriesForm(forms.ModelForm):
    class Meta:
        model = RestaurantFoodCategories
        fields ='__all__'

class AddRestaurantDrinksCategoriesForm(forms.ModelForm):
    class Meta:
...
class RestaurantFoodProductsSearchForm(forms.ModelForm):
...
class AddRestaurantFoodProductsForm(forms.ModelForm):
    class Meta:
        model = RestaurantFoodProducts
        fields ='__all__'
...
class RestaurantDrinksProductsSearchForm(forms.ModelForm):
...
class AddRestaurantDrinksProductsForm(forms.ModelForm):
    class Meta:
        model = RestaurantDrinksProducts
        fields ='__all__'
...
class UploadRestaurantFoodProductsForm(forms.ModelForm):
    class Meta:
        model = RestaurantFoodProducts
        fields ='__all__'
        
class UploadRestaurantDrinksProductsForm(forms.ModelForm):
    class Meta:
        model = RestaurantDrinksProducts
        fields ='__all__'
...
#------------------------Restaurant FOOD SEARCH ORDERS---------------
# class RestaurantFoodOrderSearchForm(forms.ModelForm):
...
#------------------------Restaurant Drinks SEARCH ORDERS---------------
# class RestaurantDrinksOrderSearchForm(forms.ModelForm):
