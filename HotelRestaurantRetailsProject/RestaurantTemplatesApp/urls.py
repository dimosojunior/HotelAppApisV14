...
#-------------RESET PASSWORD
    ...
    path('ViewRestaurantFoodCategoriesPage/<int:id>/', views.ViewRestaurantFoodCategoriesPage, name='ViewRestaurantFoodCategoriesPage'),
    path('UpdateRestaurantFoodCategories/<int:id>/', views.UpdateRestaurantFoodCategories, name='UpdateRestaurantFoodCategories'),
    path('DeleteRestaurantFoodCategories/<int:id>/', views.DeleteRestaurantFoodCategories, name='DeleteRestaurantFoodCategories'),
    ...
    #--------------------FOOD PRODUCTS-------------
    path('RestaurantFoodProductsPage/', views.RestaurantFoodProductsPage, name='RestaurantFoodProductsPage'),
    path('search_product_name_RestaurantFoodProducts_autocomplete/', views.search_product_name_RestaurantFoodProducts_autocomplete, name='search_product_name_RestaurantFoodProducts_autocomplete'),
    path('search_product_second_name_RestaurantFoodProducts_autocomplete/', views.search_product_second_name_RestaurantFoodProducts_autocomplete, name='search_product_second_name_RestaurantFoodProducts_autocomplete'),
    path('AddRestaurantFoodProducts/', views.AddRestaurantFoodProducts, name='AddRestaurantFoodProducts'),
    path('DeleteRestaurantFoodProducts/<int:id>/', views.DeleteRestaurantFoodProducts, name='DeleteRestaurantFoodProducts'),
    path('UpdateRestaurantFoodProducts/<int:id>/', views.UpdateRestaurantFoodProducts, name='UpdateRestaurantFoodProducts'),
    ...
    path('UploadRestaurantFoodProductsPage/', views.UploadRestaurantFoodProductsPage, name='UploadRestaurantFoodProductsPage'),
    ...
    path('RestaurantFoodOrderPage/', views.RestaurantFoodOrderPage, name='RestaurantFoodOrderPage'),
    path('DeleteRestaurantFoodOrder/<int:id>/', views.DeleteRestaurantFoodOrder, name='DeleteRestaurantFoodOrder'),
    ...
    #-------------------GET HOTE FOOD ORDER ITEMS-----------------
    path('ViewRestaurantFoodOrderItemsPage/<int:id>/', views.ViewRestaurantFoodOrderItemsPage, name='ViewRestaurantFoodOrderItemsPage'),
