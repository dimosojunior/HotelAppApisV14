...
#-------------RESET PASSWORD
    ...
    path('ViewRetailsFoodCategoriesPage/<int:id>/', views.ViewRetailsFoodCategoriesPage, name='ViewRetailsFoodCategoriesPage'),
    path('UpdateRetailsFoodCategories/<int:id>/', views.UpdateRetailsFoodCategories, name='UpdateRetailsFoodCategories'),
    path('DeleteRetailsFoodCategories/<int:id>/', views.DeleteRetailsFoodCategories, name='DeleteRetailsFoodCategories'),
    ...
    #--------------------FOOD PRODUCTS-------------
    path('RetailsFoodProductsPage/', views.RetailsFoodProductsPage, name='RetailsFoodProductsPage'),
    path('search_product_name_RetailsFoodProducts_autocomplete/', views.search_product_name_RetailsFoodProducts_autocomplete, name='search_product_name_RetailsFoodProducts_autocomplete'),
    path('search_product_second_name_RetailsFoodProducts_autocomplete/', views.search_product_second_name_RetailsFoodProducts_autocomplete, name='search_product_second_name_RetailsFoodProducts_autocomplete'),
    path('AddRetailsFoodProducts/', views.AddRetailsFoodProducts, name='AddRetailsFoodProducts'),
    path('DeleteRetailsFoodProducts/<int:id>/', views.DeleteRetailsFoodProducts, name='DeleteRetailsFoodProducts'),
    path('UpdateRetailsFoodProducts/<int:id>/', views.UpdateRetailsFoodProducts, name='UpdateRetailsFoodProducts'),
    ...
    path('UploadRetailsFoodProductsPage/', views.UploadRetailsFoodProductsPage, name='UploadRetailsFoodProductsPage'),
    ...
    #-------------Retails FOOD ORDERS----------------------------------
    path('RetailsFoodOrderPage/', views.RetailsFoodOrderPage, name='RetailsFoodOrderPage'),
    path('DeleteRetailsFoodOrder/<int:id>/', views.DeleteRetailsFoodOrder, name='DeleteRetailsFoodOrder'),
    ...
    path('ViewRetailsFoodOrderItemsPage/<int:id>/', views.ViewRetailsFoodOrderItemsPage, name='ViewRetailsFoodOrderItemsPage'),
