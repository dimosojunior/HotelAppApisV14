...
#----------Retails FOOD PRODUCTS CATEGORIES-------------------
class AddRetailsFoodCategoriesForm(forms.ModelForm):
    class Meta:
        model = RetailsFoodCategories
        fields ='__all__'

class AddRetailsDrinksCategoriesForm(forms.ModelForm):
    class Meta:
...
class RetailsFoodProductsSearchForm(forms.ModelForm):
...
class AddRetailsFoodProductsForm(forms.ModelForm):
    class Meta:
        model = RetailsFoodProducts
        fields ='__all__'
...
class RetailsDrinksProductsSearchForm(forms.ModelForm):
...
class AddRetailsDrinksProductsForm(forms.ModelForm):
    class Meta:
        model = RetailsDrinksProducts
        fields ='__all__'
...
class UploadRetailsFoodProductsForm(forms.ModelForm):
    class Meta:
        model = RetailsFoodProducts
        fields ='__all__'
        
class UploadRetailsDrinksProductsForm(forms.ModelForm):
    class Meta:
        model = RetailsDrinksProducts
        fields ='__all__'
...
#------------------------Retails FOOD SEARCH ORDERS---------------
# class RetailsFoodOrderSearchForm(forms.ModelForm):
...
#------------------------Retails Drinks SEARCH ORDERS---------------
# class RetailsDrinksOrderSearchForm(forms.ModelForm):
